...
class TestVector(TestCase):
    ...
    def test_if_vector_is_123_then_to_string_should_return_123_as_string(self):
        v = Vector([1, 2, 3])
        v_str = str(v)
        self.assertEqual("Vector: (1, 2, 3)", v_str)

    def test_if_vector_123_plus_321_then_result_should_be_444(self):
        first_vector = Vector([1, 2, 3])
        result = first_vector.plus(Vector([3, 2, 1]))
        self.assertEqual(Vector([4, 4, 4]), result)

    def test_if_first_vector_plus_second_vector_then_result_should_be_expected(self):
    ...
    def test_if_first_vector_minus_second_vector_then_result_should_be_expected(self):
    ...
    def test_if_vector_444_minus_321_then_result_should_be_123(self):
        first_vector = Vector([4, 4, 4])
        result = first_vector.minus(Vector([3, 2, 1]))
        self.assertEqual(Vector([1, 2, 3]), result)

    def test_if_vector_123_scalar_2_then_result_should_be_246(self):
        first_vector = Vector([1, 2, 3])
        result = first_vector.times_scalar(2)
        self.assertEqual(Vector([2, 4, 6]), result)

    def test_if_vector_scalar_then_result_should_be_expected(self):
